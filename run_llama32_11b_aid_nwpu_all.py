...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Llama 3.2-11B zero-shot, random few-shot, and global RemoteCLIP "
    ...
    for dataset in args.datasets:
        ...
        if not args.skip_zero:
            command = [
                ...
                *base_backend_args,
                "--out-dir", f"{args.out_root}/llama32_zero_{dataset}",
            ]
        ...
        for shot in args.shots:
            ...
            if not args.skip_random:
                ...
                command = [
                    ...
                    *base_backend_args,
                    "--out-dir", f"{args.out_root}/llama32_random_{dataset}_shot{shot}",
                ]
                run_command(command, args.dry_run)
            ...
            if not args.skip_knn:
                ...
                command = [
                    ...
                    *base_backend_args,
                    "--out-dir", f"{args.out_root}/llama32_knn_{dataset}_shot{shot}",
                ]
                run_command(command, args.dry_run)

    print("\nLlama 3.2-11B suite finished.", flush=True)
