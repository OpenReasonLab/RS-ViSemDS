...
RUN_ROOT="RS-ViSemDS/ablations/aid_three_classes/v4_weight_602020_reference_only_prompt"
...
echo "V4: alpha=0.6 beta=0.2 gamma=0.2; prompt=reference_only_v1"
echo "Reusing the frozen V3 selection file; only the prompt changes."
